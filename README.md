...
## Team Members
- Vaenesa Gayatri (Leader)
- Chan Hew Yan
- Chook Yao Yu
- Shirlyn Chew Ming Huey
- Muhammad Rasuli Bin Akbar Ali
...
2. **Create environment variables** by creating a `.env` file in the root directory:
   ```env
   DB_HOST=localhost
   ...
   RESUME_UPLOAD_PATH=path_to_store_uploaded_resume
   ```
